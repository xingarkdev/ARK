...
namespace CG
{
	 ...
	 */
	struct ABuff_FireAoE_Looping_C_UserConstructionScript_Params
	{	};

	/**
	 * Function Buff_FireAoE_Looping.Buff_FireAoE_Looping_C.Timeline_0__FinishedFunc
	 */
	struct ABuff_FireAoE_Looping_C_Timeline_0__FinishedFunc_Params
	{	};

	/**
	 * Function Buff_FireAoE_Looping.Buff_FireAoE_Looping_C.Timeline_0__UpdateFunc
	 */
	struct ABuff_FireAoE_Looping_C_Timeline_0__UpdateFunc_Params
	{	};

	/**
	 * Function Buff_FireAoE_Looping.Buff_FireAoE_Looping_C.ReceiveTick
	 */
	struct ABuff_FireAoE_Looping_C_ReceiveTick_Params
	{
	public:
	 ...
	 */
	struct ABuff_FireAoE_Looping_C_SetStructure_Params
	{
	public:
	 ...
	 */
	struct ABuff_FireAoE_Looping_C_DoFadeOutMesh_Params
	{	};

	/**
	 * Function Buff_FireAoE_Looping.Buff_FireAoE_Looping_C.CheckForRain
	 */
	struct ABuff_FireAoE_Looping_C_CheckForRain_Params
	{	};

	/**
	 * Function Buff_FireAoE_Looping.Buff_FireAoE_Looping_C.ReceiveBeginPlay
	 */
	struct ABuff_FireAoE_Looping_C_ReceiveBeginPlay_Params
	{	};

	/**
	 * Function Buff_FireAoE_Looping.Buff_FireAoE_Looping_C.ExecuteUbergraph_Buff_FireAoE_Looping
	 */
	struct ABuff_FireAoE_Looping_C_ExecuteUbergraph_Buff_FireAoE_Looping_Params
	{
	public:
