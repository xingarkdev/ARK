...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_M1C8[0x7];                                   // 0x0089(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_Task_StopMovement(int32_t EntryPoint);
