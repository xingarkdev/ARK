...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass DmgType_Projectile_IceSpear.DmgType_Projectile_IceSpear_C
	 * Size -> 0x000F (FullSize[0x0140] - InheritedSize[0x0131])
	 */
	class UDmgType_Projectile_IceSpear_C : public UDmgType_Projectile_C
	{
	public:
		unsigned char                                              UnknownData_AM24[0x3];                                   // 0x0131(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
