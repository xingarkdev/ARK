...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Buff_MutatingEffect.Buff_MutatingEffect_C
	 * Size -> 0x0059 (FullSize[0x09D9] - InheritedSize[0x0980])
	 */
	class ABuff_MutatingEffect_C : public APrimalBuff
	{
	public:
		...
		unsigned char                                              UnknownData_VCIG[0x7];                                   // 0x0981(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_VUYO[0x2];                                   // 0x09C6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_HIUJ[0x1];                                   // 0x09CF(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_Buff_MutatingEffect(int32_t EntryPoint);
