...
namespace CG
{
	 ...
	 */
	struct AWood_Ramp_Placement_Emitter_C_UserConstructionScript_Params
	{	};

	/**
	 * Function Wood_Ramp_Placement_Emitter.Wood_Ramp_Placement_Emitter_C.ExecuteUbergraph_Wood_Ramp_Placement_Emitter
	 */
	struct AWood_Ramp_Placement_Emitter_C_ExecuteUbergraph_Wood_Ramp_Placement_Emitter_Params
	{
	public:
