...
namespace CG
{
	 ...
	 */
	struct Acamelsaurus_AIController_BP_C_UserConstructionScript_Params
	{	};

	/**
	 * Function camelsaurus_AIController_BP.camelsaurus_AIController_BP_C.ExecuteUbergraph_camelsaurus_AIController_BP
	 */
	struct Acamelsaurus_AIController_BP_C_ExecuteUbergraph_camelsaurus_AIController_BP_Params
	{
	public:
