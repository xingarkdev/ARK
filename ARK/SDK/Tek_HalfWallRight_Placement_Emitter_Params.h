...
namespace CG
{
	 ...
	 */
	struct ATek_HalfWallRight_Placement_Emitter_C_UserConstructionScript_Params
	{	};
	 ...
	 */
	struct ATek_HalfWallRight_Placement_Emitter_C_ExecuteUbergraph_Tek_HalfWallRight_Placement_Emitter_Params
	{
	public:
