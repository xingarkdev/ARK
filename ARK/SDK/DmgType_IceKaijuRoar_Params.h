...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function DmgType_IceKaijuRoar.DmgType_IceKaijuRoar_C.BPAdjustDamage
	 */
	struct UDmgType_IceKaijuRoar_C_BPAdjustDamage_Params
	{
	public:
		...
		unsigned char                                              UnknownData_5W8A[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
