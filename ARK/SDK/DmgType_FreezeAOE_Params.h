...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function DmgType_FreezeAOE.DmgType_FreezeAOE_C.BPAdjustDamage
	 */
	struct UDmgType_FreezeAOE_C_BPAdjustDamage_Params
	{
	public:
		...
		unsigned char                                              UnknownData_ELNF[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		...
		unsigned char                                              UnknownData_1RT0[0x4];                                   // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
