...
namespace CG
{
	 ...
	 */
	class UPrimalItemArmor_ScubaBoots_Flippers_C : public UPrimalItemArmor_BaseBoots_C
	{
	public:
		...
		unsigned char                                              UnknownData_27XU[0x7];                                   // 0x0AF9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GAGF[0x7];                                   // 0x0B11(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SIN1[0x7];                                   // 0x0B21(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
