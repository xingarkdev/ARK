...
namespace CG
{
	 ...
	 */
	struct UClimber_AllowNormalAIWhileClimbing_DK_C_ReceiveConditionCheck_Params
	{
	public:
	 ...
	 */
	struct UClimber_AllowNormalAIWhileClimbing_DK_C_ExecuteUbergraph_Climber_AllowNormalAIWhileClimbing_DK_Params
	{
	public:
