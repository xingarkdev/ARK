...
namespace CG
{
	 ...
	 */
	struct AMetal_GateFrame_Large_Placement_Emitter_C_UserConstructionScript_Params
	{	};
	 ...
	 */
	struct AMetal_GateFrame_Large_Placement_Emitter_C_ExecuteUbergraph_Metal_GateFrame_Large_Placement_Emitter_Params
	{
	public:
