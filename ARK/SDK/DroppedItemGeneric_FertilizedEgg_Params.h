...
namespace CG
{
	 ...
	 */
	struct ADroppedItemGeneric_FertilizedEgg_C_UserConstructionScript_Params
	{	};
	 ...
	 */
	struct ADroppedItemGeneric_FertilizedEgg_C_ExecuteUbergraph_DroppedItemGeneric_FertilizedEgg_Params
	{
	public:
