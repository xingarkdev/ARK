...
namespace CG
{
	 ...
	 */
	struct UTek_Shield_RIG_AnimBlueprint_C_BlueprintUpdateAnimation_Params
	{
	public:
	 ...
	 */
	struct UTek_Shield_RIG_AnimBlueprint_C_ExecuteUbergraph_Tek_Shield_RIG_AnimBlueprint_Params
	{
	public:
