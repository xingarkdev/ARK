...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_84Y6[0x4];                                   // 0x0984(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_Buff_XPFromLystro(int32_t EntryPoint);
