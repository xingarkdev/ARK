...
namespace CG
{
	 ...
	 */
	struct AWood_GateFrame_Placement_Emitter_C_UserConstructionScript_Params
	{	};
	 ...
	 */
	struct AWood_GateFrame_Placement_Emitter_C_ExecuteUbergraph_Wood_GateFrame_Placement_Emitter_Params
	{
	public:
