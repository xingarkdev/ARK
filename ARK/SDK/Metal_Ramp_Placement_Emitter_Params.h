...
namespace CG
{
	 ...
	 */
	struct AMetal_Ramp_Placement_Emitter_C_UserConstructionScript_Params
	{	};

	/**
	 * Function Metal_Ramp_Placement_Emitter.Metal_Ramp_Placement_Emitter_C.ExecuteUbergraph_Metal_Ramp_Placement_Emitter
	 */
	struct AMetal_Ramp_Placement_Emitter_C_ExecuteUbergraph_Metal_Ramp_Placement_Emitter_Params
	{
	public:
