...
namespace CG
{
	 ...
	 */
	struct ASM_AdobeGateDoor_Large_BP_C_UserConstructionScript_Params
	{	};

	/**
	 * Function SM_AdobeGateDoor_Large_BP.SM_AdobeGateDoor_Large_BP_C.ExecuteUbergraph_SM_AdobeGateDoor_Large_BP
	 */
	struct ASM_AdobeGateDoor_Large_BP_C_ExecuteUbergraph_SM_AdobeGateDoor_Large_BP_Params
	{
	public:
