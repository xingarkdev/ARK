...
namespace CG
{
	 ...
	 */
	struct UDmgType_Projectile_Fire_Wyv_C_BPAdjustHarvestingDamage_Params
	{
	public:
		...
		unsigned char                                              UnknownData_3PP3[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
