...
namespace CG
{
	 ...
	 */
	struct UHM_Hoversail_Riding_AnimBP_HF_C_BlueprintUpdateAnimation_Params
	{
	public:
	 ...
	 */
	struct UHM_Hoversail_Riding_AnimBP_HF_C_ExecuteUbergraph_HM_Hoversail_Riding_AnimBP_HF_Params
	{
	public:
