...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_BKVB[0x7];                                   // 0x00A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                       CallFunc_ShouldForceFlee_ReturnValue;                    // 0x00B9(0x0001) ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor
