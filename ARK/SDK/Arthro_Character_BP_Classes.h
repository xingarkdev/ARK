...
namespace CG
{
	...
	{
	public:
		class UDinoCharacterStatusComponent_BP_Arthro_C*           DinoCharacterStatus_BP_Arthro_C1;                        // 0x2298(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
