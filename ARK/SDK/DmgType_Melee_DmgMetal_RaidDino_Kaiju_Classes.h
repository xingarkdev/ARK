...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass DmgType_Melee_DmgMetal_RaidDino_Kaiju.DmgType_Melee_DmgMetal_RaidDino_Kaiju_C
	 * Size -> 0x0000 (FullSize[0x0131] - InheritedSize[0x0131])
	 */
	class UDmgType_Melee_DmgMetal_RaidDino_Kaiju_C : public UDmgType_Melee_DmgMetal_RaidDino_C
	{
	public:
