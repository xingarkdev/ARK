...
namespace CG
{
	 ...
	 */
	struct ASM_StoneCeilingDoorGiant_BP_C_UserConstructionScript_Params
	{	};

	/**
	 * Function SM_StoneCeilingDoorGiant_BP.SM_StoneCeilingDoorGiant_BP_C.ExecuteUbergraph_SM_StoneCeilingDoorGiant_BP
	 */
	struct ASM_StoneCeilingDoorGiant_BP_C_ExecuteUbergraph_SM_StoneCeilingDoorGiant_BP_Params
	{
	public:
