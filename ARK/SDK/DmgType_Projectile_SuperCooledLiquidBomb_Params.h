...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function DmgType_Projectile_SuperCooledLiquidBomb.DmgType_Projectile_SuperCooledLiquidBomb_C.BPAdjustDamage
	 */
	struct UDmgType_Projectile_SuperCooledLiquidBomb_C_BPAdjustDamage_Params
	{
	public:
		...
		unsigned char                                              UnknownData_1B7U[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
