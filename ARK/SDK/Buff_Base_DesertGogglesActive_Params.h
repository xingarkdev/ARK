...
namespace CG
{
	 ...
	 */
	struct ABuff_Base_DesertGogglesActive_C_UserConstructionScript_Params
	{	};

	/**
	 * Function Buff_Base_DesertGogglesActive.Buff_Base_DesertGogglesActive_C.ExecuteUbergraph_Buff_Base_DesertGogglesActive
	 */
	struct ABuff_Base_DesertGogglesActive_C_ExecuteUbergraph_Buff_Base_DesertGogglesActive_Params
	{
	public:
