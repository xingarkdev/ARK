...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_0FW4[0x7];                                   // 0x0921(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_Xenomorph_AIController_BP(int32_t EntryPoint);
