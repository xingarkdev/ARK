...
namespace CG
{
	 ...
	 */
	struct UDmgType_SpikeWall_C_BPAdjustDamage_Params
	{
	public:
		...
		unsigned char                                              UnknownData_CI5A[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		...
		unsigned char                                              UnknownData_QRJZ[0x4];                                   // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
