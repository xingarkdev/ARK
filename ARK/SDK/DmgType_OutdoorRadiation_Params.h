...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function DmgType_OutdoorRadiation.DmgType_OutdoorRadiation_C.BPAdjustDamage
	 */
	struct UDmgType_OutdoorRadiation_C_BPAdjustDamage_Params
	{
	public:
		...
		unsigned char                                              UnknownData_IZQ9[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		...
		unsigned char                                              UnknownData_SNVS[0x4];                                   // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
