...
namespace CG
{
	 ...
	 */
	struct AMetal_DoorFrame_Placement_Emitter_C_UserConstructionScript_Params
	{	};
	 ...
	 */
	struct AMetal_DoorFrame_Placement_Emitter_C_ExecuteUbergraph_Metal_DoorFrame_Placement_Emitter_Params
	{
	public:
