...
namespace CG
{
	 ...
	 */
	struct AWood_CeilingDoor_Placement_Emitter_C_UserConstructionScript_Params
	{	};
	 ...
	 */
	struct AWood_CeilingDoor_Placement_Emitter_C_ExecuteUbergraph_Wood_CeilingDoor_Placement_Emitter_Params
	{
	public:
