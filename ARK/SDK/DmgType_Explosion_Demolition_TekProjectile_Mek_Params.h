...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function DmgType_Explosion_Demolition_TekProjectile_Mek.DmgType_Explosion_Demolition_TekProjectile_Mek_C.BPAdjustDamage
	 */
	struct UDmgType_Explosion_Demolition_TekProjectile_Mek_C_BPAdjustDamage_Params
	{
	public:
		...
		unsigned char                                              UnknownData_J2M8[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
