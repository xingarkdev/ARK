...
namespace CG
{
	 ...
	 */
	struct ASM_StoneCeilingDoorWay_Giant_BP_C_UserConstructionScript_Params
	{	};
	 ...
	 */
	struct ASM_StoneCeilingDoorWay_Giant_BP_C_ExecuteUbergraph_SM_StoneCeilingDoorWay_Giant_BP_Params
	{
	public:
