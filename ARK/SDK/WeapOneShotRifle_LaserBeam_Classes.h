...
namespace CG
{
	...
	{
	public:
		class UShooterLaserBeamComponent*                          TPVLaserBeam;                                            // 0x0DC8(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
		...
		class UStaticMeshComponent*                                FirstPersonAttachment;                                   // 0x0DE0(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
