...
namespace CG
{
	 ...
	 */
	class UPrimalItemArmor_NightVisionGoggles_C : public UPrimalItemArmor_BaseHelmet_C
	{
	public:
		...
		unsigned char                                              UnknownData_O3MP[0x7];                                   // 0x0AF9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EWK8[0x7];                                   // 0x0B11(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JSX9[0x7];                                   // 0x0B21(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
