...
namespace CG
{
	 ...
	 */
	struct UDmgType_Melee_DmgMetal_RaidDino_C_BPAdjustDamage_Params
	{
	public:
		...
		unsigned char                                              UnknownData_L3RN[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
