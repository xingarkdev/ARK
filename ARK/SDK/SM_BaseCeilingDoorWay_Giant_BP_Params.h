...
namespace CG
{
	 ...
	 */
	struct ASM_BaseCeilingDoorWay_Giant_BP_C_UserConstructionScript_Params
	{	};

	/**
	 * Function SM_BaseCeilingDoorWay_Giant_BP.SM_BaseCeilingDoorWay_Giant_BP_C.ExecuteUbergraph_SM_BaseCeilingDoorWay_Giant_BP
	 */
	struct ASM_BaseCeilingDoorWay_Giant_BP_C_ExecuteUbergraph_SM_BaseCeilingDoorWay_Giant_BP_Params
	{
	public:
