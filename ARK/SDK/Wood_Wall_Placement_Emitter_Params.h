...
namespace CG
{
	 ...
	 */
	struct AWood_Wall_Placement_Emitter_C_UserConstructionScript_Params
	{	};

	/**
	 * Function Wood_Wall_Placement_Emitter.Wood_Wall_Placement_Emitter_C.ExecuteUbergraph_Wood_Wall_Placement_Emitter
	 */
	struct AWood_Wall_Placement_Emitter_C_ExecuteUbergraph_Wood_Wall_Placement_Emitter_Params
	{
	public:
