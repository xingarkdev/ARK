...
namespace CG
{
	 ...
	 */
	struct UCompass_FPV_RIG_AnimBlueprint_C_BlueprintUpdateAnimation_Params
	{
	public:
	 ...
	 */
	struct UCompass_FPV_RIG_AnimBlueprint_C_ExecuteUbergraph_Compass_FPV_RIG_AnimBlueprint_Params
	{
	public:
