...
namespace CG
{
	 ...
	 */
	struct AWood_Piller_Placement_Emitter_C_UserConstructionScript_Params
	{	};

	/**
	 * Function Wood_Piller_Placement_Emitter.Wood_Piller_Placement_Emitter_C.ExecuteUbergraph_Wood_Piller_Placement_Emitter
	 */
	struct AWood_Piller_Placement_Emitter_C_ExecuteUbergraph_Wood_Piller_Placement_Emitter_Params
	{
	public:
