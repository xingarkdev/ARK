...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function DmgType_Melee_DmgMetal_CorruptDino.DmgType_Melee_DmgMetal_CorruptDino_C.BPAdjustDamage
	 */
	struct UDmgType_Melee_DmgMetal_CorruptDino_C_BPAdjustDamage_Params
	{
	public:
		...
		unsigned char                                              UnknownData_0NIO[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
