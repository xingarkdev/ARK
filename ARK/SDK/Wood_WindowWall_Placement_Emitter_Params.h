...
namespace CG
{
	 ...
	 */
	struct AWood_WindowWall_Placement_Emitter_C_UserConstructionScript_Params
	{	};
	 ...
	 */
	struct AWood_WindowWall_Placement_Emitter_C_ExecuteUbergraph_Wood_WindowWall_Placement_Emitter_Params
	{
	public:
