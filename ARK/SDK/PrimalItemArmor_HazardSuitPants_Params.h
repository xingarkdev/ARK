...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_TNP5[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	 ...
	 */
	struct UPrimalItemArmor_HazardSuitPants_C_ExecuteUbergraph_PrimalItemArmor_HazardSuitPants_Params
	{
	public:
