...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function DmgType_TentacleProj.DmgType_TentacleProj_C.BPAdjustDamage
	 */
	struct UDmgType_TentacleProj_C_BPAdjustDamage_Params
	{
	public:
		...
		unsigned char                                              UnknownData_ZS23[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
