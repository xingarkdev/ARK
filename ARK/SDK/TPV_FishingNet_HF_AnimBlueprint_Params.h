...
namespace CG
{
	 ...
	 */
	struct UTPV_FishingNet_HF_AnimBlueprint_C_BlueprintUpdateAnimation_Params
	{
	public:
	 ...
	 */
	struct UTPV_FishingNet_HF_AnimBlueprint_C_ExecuteUbergraph_TPV_FishingNet_HF_AnimBlueprint_Params
	{
	public:
