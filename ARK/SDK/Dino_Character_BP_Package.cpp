...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x0178CEC0
	 * 		Name   -> Function Dino_Character_BP.Dino_Character_BP_C.UserConstructionScript
	...
	void ADino_Character_BP_C::UserConstructionScript()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Dino_Character_BP.Dino_Character_BP_C.UserConstructionScript");
