...
namespace CG
{
	 ...
	 */
	struct UrocketLauncher_TPV_RIG_AnimBlueprint_C_BlueprintUpdateAnimation_Params
	{
	public:
	 ...
	 */
	struct UrocketLauncher_TPV_RIG_AnimBlueprint_C_ExecuteUbergraph_rocketLauncher_TPV_RIG_AnimBlueprint_Params
	{
	public:
