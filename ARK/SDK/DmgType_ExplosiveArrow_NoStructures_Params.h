...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function DmgType_ExplosiveArrow_NoStructures.DmgType_ExplosiveArrow_NoStructures_C.BPAdjustDamage
	 */
	struct UDmgType_ExplosiveArrow_NoStructures_C_BPAdjustDamage_Params
	{
	public:
		...
		unsigned char                                              UnknownData_BRZV[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
