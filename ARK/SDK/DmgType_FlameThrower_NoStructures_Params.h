...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function DmgType_FlameThrower_NoStructures.DmgType_FlameThrower_NoStructures_C.BPAdjustDamage
	 */
	struct UDmgType_FlameThrower_NoStructures_C_BPAdjustDamage_Params
	{
	public:
		...
		unsigned char                                              UnknownData_ABJF[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		...
		unsigned char                                              UnknownData_RNSG[0x4];                                   // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
