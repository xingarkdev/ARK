...
namespace CG
{
	 ...
	 */
	struct ADroppedItemGeneric_FertilizedEgg_NoPhysics_C_UserConstructionScript_Params
	{	};
	 ...
	 */
	struct ADroppedItemGeneric_FertilizedEgg_NoPhysics_C_ExecuteUbergraph_DroppedItemGeneric_FertilizedEgg_NoPhysics_Params
	{
	public:
