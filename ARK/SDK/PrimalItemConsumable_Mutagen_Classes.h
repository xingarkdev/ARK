...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_CTRX[0x3];                                   // 0x0B11(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		int32_t                                                    savedamountofmutagenneeded;                              // 0x0B20(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	...
	public:
		...
		void ExecuteUbergraph_PrimalItemConsumable_Mutagen(int32_t EntryPoint);
