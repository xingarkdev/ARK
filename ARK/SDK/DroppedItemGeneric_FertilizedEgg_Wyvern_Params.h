...
namespace CG
{
	 ...
	 */
	struct ADroppedItemGeneric_FertilizedEgg_Wyvern_C_UserConstructionScript_Params
	{	};
	 ...
	 */
	struct ADroppedItemGeneric_FertilizedEgg_Wyvern_C_ExecuteUbergraph_DroppedItemGeneric_FertilizedEgg_Wyvern_Params
	{
	public:
